...
export const Header = (): React.ReactElement => {
	...
	return (
		<InternalHeader
			...
			data-testid="innlogget-header"
		>
			<InternalHeader.Title
				href={FORSIDE_PAGE_ROUTE}
				aria-label="lenke til startsiden"
			>
			...
			<Dropdown>
				...
				<Dropdown.Menu>
					<Dropdown.Menu.GroupedList>
						...
						>
							<Link
								ref={tiltakstyperLinkRef}
								to={`${tiltaksadministrasjonUrl}/tiltakstyper`}
								target="_blank"
							>
								Tiltakstyper
							</Link>
						...
						>
							<Link
								ref={avtalerLinkRef}
								to={`${tiltaksadministrasjonUrl}/avtaler`}
								target="_blank"
							>
								Avtaler
							</Link>
						...
						<Dropdown.Menu.GroupedList.Item
							onClick={() =>
								gjennomforingerLinkRef.current?.click()
							}
							as="span"
						>
							<Link
						...
						<Dropdown.Menu.GroupedList.Item
							onClick={() =>
								notifikasjonerLinkRef.current?.click()
							}
							as="span"
						>
							<Link
								ref={notifikasjonerLinkRef}
								to={`${tiltaksadministrasjonUrl}/notifikasjoner`}
								target="_blank"
							>
								Notifikasjoner
							</Link>
						...
						<Dropdown.Menu.GroupedList.Item
							onClick={() =>
								individuelleGjennomforingerLinkRef.current?.click()
							}
							as="span"
						>
							<Link
								ref={individuelleGjennomforingerLinkRef}
								to={mulighetsrommetSanityUrl}
								target="_blank"
							>
						...
						<Dropdown.Menu.GroupedList.Item
							onClick={() =>
								veilederflateLinkRef.current?.click()
							}
							as="span"
						>
							<Link
								ref={veilederflateLinkRef}
								to={navArbeidsmarkedstiltakUrl}
								target="_blank"
							>
						...
						<Dropdown.Menu.GroupedList.Item
							onClick={() =>
								endringsmeldingerLinkRef.current?.click()
							}
							as="span"
						>
			...
			<InternalHeader.User
				...
				description={innloggetAnsatt.navIdent ?? '...'}
